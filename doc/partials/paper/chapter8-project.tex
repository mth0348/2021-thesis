...
% mention compute shader...
% the rest is additional optimization
...
% TODO mention that meteoblue might have real-time API
% TODO its more a license issue than a technical issue
