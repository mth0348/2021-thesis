...
\begin{figure}[ht]
    \centering
        \begin{minipage}{0.47\linewidth}
            ...
            \captionof{figure}{Result of the previous work's shader (Evening setting).}
        \end{minipage}
    \hfill
        \begin{minipage}{0.47\linewidth}
            \includegraphics[width=\linewidth]{project2/project2-final2.PNG}
            \captionof{figure}{Result of the previous work's shader (Day setting).}
        \end{minipage}  
\end{figure}
...
As mentioned in \sectionref{section:externaldata}, the data will not be retrieved in real-time, but rather be polled periodically.
