...
\newglossaryentry{cnn}{name=CNN, text={CNN}, first={convolutional neural network (CNN)}, description={ A \gls{neuralnetwork} that is able to classify images }} 
\newglossaryentry{gan}{name=GAN, text={GAN}, first={generative adversarial network (GAN)}, description={ A set of two \gls{neuralnetwork}s, where one generates images and the other tries to tell wether those images are real or generated }} 
...
\newglossaryentry{dotproduct}{name=Dot product, text={dot product}, description={ In mathematics, and geometrically, the dot product is the product of the Euclidean magnitudes of two vectors and the cosine of the angle between them }}