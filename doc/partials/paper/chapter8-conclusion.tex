...
In \sectionref{section:impl}, a prediction model was described where data of future forecast would be used to estimate the cloud types, but this was not implemented in the final weather rendering system. Instead, the cloud coverage data provided by the "clouds-1h" package was used.
\\
