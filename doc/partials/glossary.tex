...
\newglossaryentry{fragmentshader}{name=Fragment shader, text={fragmentshader}, description={ A \gls{shader} that processes single pixels, called \gls{fragment}s, calculates its color and outputs that to the \gls{framebuffer} }}
