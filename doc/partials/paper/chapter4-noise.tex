...
The following figure shows that the \gls{computeshader} is dispatched in a large group of thread groups, each containing a number of threads, which represent a single invocation of the \gls{shader}.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \fill[red!50] (3.1,3.1) rectangle (3.9,3.9);
        \draw[c,red] (3.1,3.1) rectangle (3.9,3.9);
       ...
       \draw [decorate,decoration={brace,amplitude=10pt}] (5.5,-1) -- (0,-1)  node [black,midway,yshift=-0.75cm] {dispatch};
        ...
        % thread group
        \draw[c] (8,1) rectangle (11.9,4.9);
        % threads
        \draw[c,red] (8.2,1.2) rectangle (9,2); %--
        \draw[c,red] (9.1,1.2) rectangle (9.9,2);
        \draw[c,red] (10,1.2) rectangle (10.8,2);
        \draw[c,red] (10.9,1.2) rectangle (11.7,2);
        \draw[c,red] (8.2,2.1) rectangle (9,2.9); %--
        \draw[c,red] (9.1,2.1) rectangle (9.9,2.9);
        \draw[c,red] (10,2.1) rectangle (10.8,2.9);
        \draw[c,red] (10.9,2.1) rectangle (11.7,2.9);
        \draw[c,red] (8.2,3) rectangle (9,3.8); %--
        \draw[c,red] (9.1,3) rectangle (9.9,3.8);
        \draw[c,red] (10,3) rectangle (10.8,3.8);
        \draw[c,red] (10.9,3) rectangle (11.7,3.8);
        \draw[c,red] (8.2,3.9) rectangle (9,4.7); %--
        \draw[c,red] (9.1,3.9) rectangle (9.9,4.7);
        \draw[c,red] (10,3.9) rectangle (10.8,4.7);
        \draw[c,red] (10.9,3.9) rectangle (11.7,4.7);

        % strike throughs
        \draw[red] (8.2,1.2) -- (9,2);
        \draw[red] (9,1.2) -- (8.2,2);
        \draw[red] (9.1,1.2) -- (9.9,2);
        \draw[red] (9.9,1.2) -- (9.1,2);
        \draw[red] (10,1.2) -- (10.8,2);
        \draw[red] (10.8,1.2) -- (10,2);
        \draw[red] (10.9,1.2) -- (11.7,2);
        \draw[red] (11.7,1.2) -- (10.9,2);
        \draw[red] (8.2,2.1) -- (9,2.9); %--
        \draw[red] (9,2.1) -- (8.2,2.9); %--
        \draw[red] (9.1,2.1) -- (9.9,2.9);
        \draw[red] (9.9,2.1) -- (9.1,2.9);
        \draw[red] (10,2.1) -- (10.8,2.9);
        \draw[red] (10.8,2.1) -- (10,2.9);
        \draw[red] (10.9,2.1) -- (11.7,2.9);
        \draw[red] (11.7,2.1) -- (10.9,2.9);
        \draw[red] (8.2,3) -- (9,3.8); %--
        \draw[red] (9,3) -- (8.2,3.8); %--
        \draw[red] (9.1,3) -- (9.9,3.8);
        \draw[red] (9.9,3) -- (9.1,3.8);
        \draw[red] (10,3) -- (10.8,3.8);
        \draw[red] (10.8,3) -- (10,3.8);
        \draw[red] (10.9,3) -- (11.7,3.8);
        \draw[red] (11.7,3) -- (10.9,3.8);
        \draw[red] (8.2,3.9) -- (9,4.7); %--
        \draw[red] (9,3.9) -- (8.2,4.7); %--
        \draw[red] (9.1,3.9) -- (9.9,4.7);
        \draw[red] (9.9,3.9) -- (9.1,4.7);
        \draw[red] (10,3.9) -- (10.8,4.7);
        \draw[red] (10.8,3.9) -- (10,4.7);
        \draw[red] (10.9,3.9) -- (11.7,4.7);
        \draw[red] (11.7,3.9) -- (10.9,4.7);

        \draw[smalledge] (12,4.3) -- (14.5,4);
        
        \draw [decorate,decoration={brace,amplitude=10pt}] (12,-1) -- (8,-1)  node [black,midway,yshift=-0.75cm] {thread group};

        % thread
        \draw[c,red] (15,3.5) rectangle (16,4.5);
        \draw[red] (15,3.5) -- (16,4.5);
        \draw[red] (16,3.5) -- (15,4.5);
