...
\\
According to Rademacher \cite{diglib:realism}, the shadow softness of cast shadows is a great way of determining how realistic a rendered image looks.
...
That is an astounding \textbf{3000\%} more resourceful.
\\
For almost all of this, credit has to be given to the use of a \gls{computeshader}.
The fact that the \gls{noise} has to be calculated only once allows for much higher fidelity in rendering the clouds.
\emptyline
