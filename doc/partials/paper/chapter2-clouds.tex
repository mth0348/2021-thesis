...
Since clouds are classified in three major layers, it is reasonable to create an implementation approach that follows a similar structure.
Knowing that there are only a few differences between som cloud types, they could be combined or grouped together.
