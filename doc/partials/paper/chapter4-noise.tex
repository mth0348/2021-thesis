...
\emptyline
All of the following documented procedures and algorithms were implemented in 3D, but for the matter of explanation, it is described and visualized in 2D.
...
\emptyline
Those algorithms will not be further explained, as they have already been described in the previous project. More information can be found in the referenced document.
...
\noindent
As recognizable in \autoref{img:tikz:noise:voronoi2}, hard contours are still visible along the grid lines. This can be improved by including the adjacent cells when finding the closest seed for any given fragment.
...
\begin{figure}[H]
    ...
    \caption{Partially seamless, tiled 3D \gls{noise} \gls{textureslice}s, showing artifacts of the modulo error.}
...
The following figure shows that the \gls{computeshader} is dispatched with a large number of thread groups, each containing a set of threads, of which each represents a single invocation of the \gls{shader}.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \tikzset{cb2/.style = {shorten <=-2.5pt, shorten >=-2.5pt, black!30}}
        ...
        \draw[c,red!50] (3.3,3.3) rectangle (3.9,3.9);
        \draw[c,red!75] (3.2,3.2) rectangle (3.8,3.8);
        \fill[red!50] (3.1,3.1) rectangle (3.7,3.7);
        \draw[c,red] (3.1,3.1) rectangle (3.7,3.7);
        ...
        \draw[smalledge] (4.3,3.5) -- (7.5,3);
       \draw [decorate,decoration={brace,amplitude=10pt}] (5.5,-1) -- (0,-1)  node [black,midway,yshift=-0.75cm] {dispatch};

        % thread group
        \draw[c] (8,0) rectangle (11.9,3.9);
        % threads
        \draw[c,red] (8.2,0.2) rectangle (9,1); %--
        \draw[c,red] (9.1,0.2) rectangle (9.9,1);
        \draw[c,red] (10,0.2) rectangle (10.8,1);
        \draw[c,red] (10.9,0.2) rectangle (11.7,1);
        \draw[c,red] (8.2,1.1) rectangle (9,1.9); %--
        \draw[c,red] (9.1,1.1) rectangle (9.9,1.9);
        \draw[c,red] (10,1.1) rectangle (10.8,1.9);
        \draw[c,red] (10.9,1.1) rectangle (11.7,1.9);
        \draw[c,red] (8.2,2) rectangle (9,2.8); %--
        \draw[c,red] (9.1,2) rectangle (9.9,2.8);
        \draw[c,red] (10,2) rectangle (10.8,2.8);
        \draw[c,red] (10.9,2) rectangle (11.7,2.8);
        \draw[c,red] (8.2,2.9) rectangle (9,3.7); %--
        \draw[c,red] (9.1,2.9) rectangle (9.9,3.7);
        \draw[c,red] (10,2.9) rectangle (10.8,3.7);
        \draw[c,red] (10.9,2.9) rectangle (11.7,3.7);

        % strike throughs
        \draw[red] (8.2,0.2) -- (9,1);
        \draw[red] (9,0.2) -- (8.2,1);
        \draw[red] (9.1,0.2) -- (9.9,1);
        \draw[red] (9.9,0.2) -- (9.1,1);
        \draw[red] (10,0.2) -- (10.8,1);
        \draw[red] (10.8,0.2) -- (10,1);
        \draw[red] (10.9,0.2) -- (11.7,1);
        \draw[red] (11.7,0.2) -- (10.9,1);
        \draw[red] (8.2,1.1) -- (9,1.9); %--
        \draw[red] (9,1.1) -- (8.2,1.9); %--
        \draw[red] (9.1,1.1) -- (9.9,1.9);
        \draw[red] (9.9,1.1) -- (9.1,1.9);
        \draw[red] (10,1.1) -- (10.8,1.9);
        \draw[red] (10.8,1.1) -- (10,1.9);
        \draw[red] (10.9,1.1) -- (11.7,1.9);
        \draw[red] (11.7,1.1) -- (10.9,1.9);
        \draw[red] (8.2,2) -- (9,2.8); %--
        \draw[red] (9,2) -- (8.2,2.8); %--
        \draw[red] (9.1,2) -- (9.9,2.8);
        \draw[red] (9.9,2) -- (9.1,2.8);
        \draw[red] (10,2) -- (10.8,2.8);
        \draw[red] (10.8,2) -- (10,2.8);
        \draw[red] (10.9,2) -- (11.7,2.8);
        \draw[red] (11.7,2) -- (10.9,2.8);
        \draw[red] (8.2,2.9) -- (9,3.7); %--
        \draw[red] (9,2.9) -- (8.2,3.7); %--
        \draw[red] (9.1,2.9) -- (9.9,3.7);
        \draw[red] (9.9,2.9) -- (9.1,3.7);
        \draw[red] (10,2.9) -- (10.8,3.7);
        \draw[red] (10.8,2.9) -- (10,3.7);
        \draw[red] (10.9,2.9) -- (11.7,3.7);
        \draw[red] (11.7,2.9) -- (10.9,3.7);

        % first back
        \node (offset) at (8,0) {};
        \node (a1b1) at ($(offset) + (0.25,4)$)   {};
        \node (a2b1) at ($(offset) + (1.25,4)$)   {};
        \node (a3b1) at ($(offset) + (2.25,4)$)   {};
        \node (a4b1) at ($(offset) + (3.25,4)$)   {};
        \node (a1b2) at ($(offset) + (0.25,4.25)$) {};
        \node (a2b2) at ($(offset) + (1.25,4.25)$) {};
        \node (a3b2) at ($(offset) + (2.25,4.25)$) {};
        \node (a4b2) at ($(offset) + (3.25,4.25)$) {};
        \node (a5b2) at ($(offset) + (4.25,4.25)$) {};
        \node (c1d1) at ($(offset) + (4,0.25)$)   {};
        \node (c1d2) at ($(offset) + (4,1.25)$)   {};
        \node (c1d3) at ($(offset) + (4,2.25)$)   {};
        \node (c1d4) at ($(offset) + (4,3.25)$)   {};
        \node (c2d1) at ($(offset) + (4.25,0.25)$) {};
        \node (c2d2) at ($(offset) + (4.25,1.25)$) {};
        \node (c2d3) at ($(offset) + (4.25,2.25)$) {};
        \node (c2d4) at ($(offset) + (4.25,3.25)$) {};
        \draw[cb] (a1b2) edge node{} (a5b2);
        \draw[cb] (c2d1) edge node{} (a5b2);
        \draw[cb2] (a1b1) edge node{} (a1b2);
        \draw[cb2] (a2b1) edge node{} (a2b2);
        \draw[cb2] (a3b1) edge node{} (a3b2);
        \draw[cb2] (a4b1) edge node{} (a4b2);
        \draw[cb2] (c1d1) edge node{} (c2d1);
        \draw[cb2] (c1d2) edge node{} (c2d2);
        \draw[cb2] (c1d3) edge node{} (c2d3);
        \draw[cb2] (c1d4) edge node{} (c2d4);
    
        % second back
        \node (offset) at (8.25,0.25) {};
        \node (a1b1) at ($(offset) + (0.25,4)$)   {};
        \node (a2b1) at ($(offset) + (1.25,4)$)   {};
        \node (a3b1) at ($(offset) + (2.25,4)$)   {};
        \node (a4b1) at ($(offset) + (3.25,4)$)   {};
        ...
        \draw[smalledge] (12,3.3) -- (14.5,3);
        
        \draw [decorate,decoration={brace,amplitude=10pt}] (12,-1) -- (8,-1)  node [black,midway,yshift=-0.75cm] {thread group};

        % thread
        \draw[c,red] (15,2.5) rectangle (16,3.5);
        \draw[red] (15,2.5) -- (16,3.5);
        \draw[red] (16,2.5) -- (15,3.5);

        \draw [decorate,decoration={brace,amplitude=10pt}] (17,-1) -- (14,-1)  node [black,midway,yshift=-0.75cm] {invocation (thread)};

    \end{tikzpicture}
    \captionof{figure}{Hierarchical thread structure of compute shaders.}
...
When dispatching a \gls{kernel} with 64 groups in each dimension, it means that the group identifiers range from (0,0,0) to (63,63,63).
\\
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \end{tikzpicture}
        \captionof{figure}{Compute shader thread group with dimensions 4x4x4. Marked in red is thread $t_1 $ with $id_1 = (0,0,0)$.}
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \end{tikzpicture}
        \captionof{figure}{Compute shader thread group with dimensions 4x4x4. Marked in red is thread $t_2 $ with $id_2 = (7,255,9)$.}
...
The algorithms described in \sectionref{section:noise} can be used unaltered in the final implementation.
With the ability to use a total of four different noise values for each \gls{fragment} in the \gls{fragmentshader}, the generated \gls{noise} will provide plenty of randomness.