...
\newglossaryentry{shader}{name=Shader, text={shader}, description={ A piece of software which runs on the GPU, rendering geometrically defined objects to the screen  }} 
