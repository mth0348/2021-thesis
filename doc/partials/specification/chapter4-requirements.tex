...
\noindent\begin{tabularx}{\linewidth}{|l|X|}
    ...
    \newline \newline There are many camera systems that offer 360-degree footage free of charge. The chosen system is that of the company \emph{Seitz} called \emph{Roundshot}, with these locations: 
    \begin{itemize}
