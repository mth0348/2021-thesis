...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\linewidth}
        \begin{tikzpicture}
            ...
            % warm front moisture
            \draw[red] (0.3,0.3) circle (0.1cm);
            \draw[red] (0.4,0.85) circle (0.1cm);
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\linewidth}
        \begin{tikzpicture}
            ...
            \draw[cyan!50!blue,edge] (0.5,0.5) -- (1.4,0.5);
            \draw[cyan!50!blue,edge] (0.3,1) -- (1.2,1);
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \end{tikzpicture}
        \captionof{figure}{Occluded front: The very col air caught up and mixes with the preceding cold front. An occluded front is created, bringing heavy \gls{precipitation}.}
