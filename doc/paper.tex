...
\clearpage
\input{partials/paper/chapter6-testing.tex}
\clearpage
\input{partials/paper/chapter7-conclusion.tex}
\clearpage
\input{partials/paper/chapter8-project.tex}
\clearpage
\input{partials/declaration-authorship.tex}
\clearpage

\begin{appendices}
    \includepdf[pages=1,pagecommand=\section{Bachelor Project Specification Document},width=\textwidth]{specification.pdf}
    \includepdf[pages=2-,pagecommand={},width=\textwidth]{specification.pdf}
    
    \includepdf[pages=1,pagecommand=\section{Previous Work: Procedural Cloud Shader},width=\textwidth]{project2.pdf}
    \includepdf[pages=2-,pagecommand={},width=\textwidth]{project2.pdf}
\end{appendices}
