...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \end{tikzpicture}
        \captionof{figure}{Compute shader thread group with dimensions 4x4x4. Marked in blue is thread \color{red}$t_1$ \color{black} with id (0,0,0).}
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \begin{tikzpicture}[scale=0.6, x=2cm,y=2cm]
            ...
            \node[red] at (4.2,4.2) {$t_2$};
        
        \end{tikzpicture}
        \captionof{figure}{Compute shader thread group with dimensions 4x4x4. Marked in blue is thread \color{red}$t_2$ \color{black} with id (7,255,9)}
