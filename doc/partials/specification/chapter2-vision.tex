...
\noindent
All external data is retrieved regularly and stored on the local file system. The file formats of every data source are denoted in their respective bottom left corner.
