...
\begin{ganttchart}[
    ...
    \ganttbar{Specification}{1}{4} \\
    \ganttmilestone{Specification finished}{4} \\
    \ganttmilestone{Expert meeting 1}{4} \\
    \ganttgroup{Research}{5}{11} \\
    \ganttbar{Documentation}{5}{11} \\
    \ganttmilestone{Interview with meteoblue}{6} \\
    \ganttgroup{Implementation}{7}{15} \\
    \ganttbar{Impl: Data processing}{7}{8} \\
    \ganttbar{Impl: Rendering system}{9}{13} \\
    \ganttbar{Impl: User interface}{14}{15} \\
    \ganttmilestone{Progress evaluation}{11} \\
    \ganttmilestone{Expert meeting 2}{15} \\
    \ganttmilestone{Implementation finished}{15} \\
    \ganttgroup{Finalizing}{16}{16} \\
    \ganttbar{Clean-up and review}{16}{16}
\end{ganttchart}
